...
export const ClientSkeleton: React.FC = () => {
  return (
    <div className="border border-mediumGray bg-white rounded-xl shadow-sm animate-pulse">
      <div className="grid grid-cols-1 lg:grid-cols-3 p-5 gap-4 lg:gap-2">
        {/* Name and details */}
        ...
        {/* Buttons */}
        <div className="lg:col-span-1 flex items-center justify-start lg:justify-end mt-3 lg:mt-0">

            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <TextArea
                  ...
                  error={
                    errors.memoryAndReasoning?.detailedTable?.identifiedProblem1
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <TextArea
                  ...
                  error={
                    errors.memoryAndReasoning?.detailedTable?.identifiedProblem2
                      ?.identifiedProblem?.message
                  }
                  rows={3}
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <TextArea
                  ...
                  error={
                    errors.memoryAndReasoning?.detailedTable?.identifiedProblem3
                      ?.identifiedProblem?.message
                  }
                  rows={3}
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <TextArea
                  ...
                  error={
                    errors.memoryAndReasoning?.detailedTable?.identifiedProblem4
                      ?.identifiedProblem?.message
                  }
                  rows={3}
                />

...
import { hospitalizationChecklistSchema } from "@agensy/config";
...
interface HospitalizationChecklistPDFProps {
...
export const HospitalizationChecklistPDF: React.FC<
  HospitalizationChecklistPDFProps
> = ({ data, schema = hospitalizationChecklistSchema }) => {
  const headings = schema.filter((field) => field.type === "heading");

  return (
    <Document title="Agensy Hospitalization Checklist">
      <Page size="A4" style={styles.page}>
        <Text style={styles.formTitle}>Agensy Hospitalization Checklist</Text>

    ...
    <>
      ...
      >
              ...
              >
                ...
                <div className="mb-4">
                  <Input
                    ...
                    error={
                      errors.focusedRecommendations?.[index]?.name?.message
                    }
                  />
                </div>
                <div className="mb-4">
                  <Input
                    ...
                    error={
                      errors.focusedRecommendations?.[index]?.description
                        ?.message
                    }
                  />
                </div>
                <div className="mb-4">
                  <MultipleTextInputs
                    label="Details"
                    value={
                      watch(`focusedRecommendations.${index}.details`) || []
                    }
                    onChange={(newValue) => {
                      setValue(
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="mb-4 p-3 bg-blue-100 rounded border-l-4 border-blue-500 text-sm text-gray-700">
                ...
                own medication, and ability to handle finances. Describe the
                care recipient's perceptions and attitude towards receiving IADL
                assistance, whether verbal prompting / reminders are sufficient,
                and any other information pertinent to the provision of
        ...
        <Card title="Home Safety">
          <div className="mb-4 p-3 bg-blue-100 rounded border-l-4 border-blue-500 text-sm text-gray-700">
            [Summarize your observations of the care recipient's home
            environment and any pertinent safety and/or functional concerns in a
            narrative fashion. Address whether the care recipient require
            assistance maintaining the property including home upkeep, lawn
            maintenance, etc. Describe the home: how many stories, do the
            staircase have a railing or landings, are there safety gates or can
            they be installed, is the yard fenced, are pathways wide enough for
            a walker or wheelchair, are showers accessible, and do drawers and
            cabinets have safety latches, etc. Please note any modifications
            that may be necessary to address any safety concerns observed.]
          </div>
          <div className="mb-5">
            <TextArea
        ...
        <Card title="Memory & Reasoning">
          <div className="mb-4 p-3 bg-blue-100 rounded border-l-4 border-blue-500 text-sm text-gray-700">
            [Please include a description of the care recipient’s general
            memory, reasoning, and other cognitive capacities. If there is any
            notable decline, has it been rapid or gradual? What insight into
            their own cognitive decline does the care recipient demonstrate?
            Likewise, what insight into any pertinent safety concerns does the
            care recipient demonstrate? Does the care recipient experience any
            hallucinations or evidence any delusions? To what degree is the care
            recipient able to engage in linear conversation, and are there
            patterns or perseverations informed by the care recipient’s
            cognitive concerns? What is the care recipient’s range of emotional
            expression, and is it situationally appropriate? Do any
            conversational topics or other stimuli trigger an acute emotional
            response? How does the care recipient’s cognition impact their
            ability to remain organized, or attend to their ADLs and IADLs (see
            above sections)?]
          </div>
          <div className="mb-5">
            <TextArea
        ...
        <Card title="Geriatric Depression">
          <div className="mb-4 p-3 bg-blue-100 rounded border-l-4 border-blue-500 text-sm text-gray-700">
            ...
            to what degree does the care recipient express or demonstrate
            feeling sad, unmotivated, discouraged, or hopeless? Does the care
            recipient have opportunities to engage in activities relevant to
            their interests and intellect? Have others expressed any concerns
            for the care recipient’s emotional wellbeing? If evidence of
            depression is noted, please indicate any suspected or suggested
        ...
        <Card title="Legal and Financial">
          <div className="mb-4 p-3 bg-blue-100 rounded border-l-4 border-blue-500 text-sm text-gray-700">
            [Summarize the care recipient's general legal and financial status
            in a narrative format. Is all legal and financial documentation up
            to date and appropriate? Do the care recipient or their family have
            any concerns for the cost of care or other services? Does the care
        ...
        <Card title="Caregiver Support">
          <div className="mb-4 p-3 bg-blue-100 rounded border-l-4 border-blue-500 text-sm text-gray-700">
            [Summarize any caregiver support that the care recipient receives
            from a family, community, or other agency. Who are the care
            recipient's caregivers and what duties do they primarily perform?
            What is the care recipient's association to and opinion of their
            caregivers? Are there any concerns for the caregivers' competence,
